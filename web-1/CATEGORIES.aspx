            ...
            <table class="auto-style1">
                <tr>
                    <td class="auto-style3">
                        &nbsp;
                        <asp:Image ID="Image2" runat="server" Height="162px" ImageUrl="~/photos/MEDICATONS.jpg" Width="274px" />
                        <br />
                    ...
                    <td class="auto-style2">
                        <asp:Image ID="Image3" runat="server" Height="114px" ImageUrl="~/photos/download.png" Width="271px" />
                        <br />
                        <br />
                ...
                <tr>
                    <td class="auto-style4">
                        &nbsp;<asp:Image ID="Image4" runat="server" ImageUrl="~/photos/skin-care.jpg" />
                        <br />
                        <asp:Button ID="Button3" runat="server" BackColor="#FF9933" ForeColor="#FFCCCC" Height="60px" Text="SKIN CARE" Width="279px" />
                    </td>
                    <td>
                        <asp:Image ID="Image1" runat="server" Height="172px" ImageUrl="~/photos/hair care.jpg" Width="288px" />
                        <br />
                ...
                <tr>
                    <td class="auto-style4">
                        <br />
                        <asp:Image ID="Image6" runat="server" Height="160px" ImageUrl="~/photos/beauty.jpg" Width="268px" />
                        <br />
                    ...
                    <td>
                        <asp:Image ID="Image7" runat="server" Height="191px" ImageUrl="~/photos/personal care.jpg" Width="296px" />
                        <br />
                ...
                <tr>
                    <td class="auto-style4">
                        <br />
                        <asp:Image ID="Image8" runat="server" Height="192px" ImageUrl="~/photos/perfumes.jpg" Width="274px" />
                        <br />
                    ...
                    <td>
                        <br />
                        <asp:Image ID="Image10" runat="server" Height="182px" ImageUrl="~/photos/baby care.jpg" Width="312px" />
                        <br />
                ...
                <tr>
                    <td class="auto-style4">
                        <br />
                        <asp:Image ID="Image9" runat="server" Height="201px" ImageUrl="~/photos/medical supplies.jpg" Width="275px" />
                        <br />
                    ...
                    <td>
                        <br />
                        <asp:Image ID="Image11" runat="server" Height="191px" ImageUrl="~/photos/general use.jpg" Width="295px" />
                        <br />
